  ...
  return (
    <section className="member-card-page">
      ...
      <div className="member-card-header">
        <div>
          <span className="member-card-eyebrow">
      ...
      {message && (
        <p className={`member-card-message ${messageType}`}>
          {message}
        </p>
      )}
      ...
      {approvedApps.length > 0 ? (
        <>
          <div className="member-card-count-bar">
            <span>
              {approvedApps.length} active membership card
              {approvedApps.length > 1 ? 's' : ''}
            </span>
          </div>
              ...
              >
                ...
                <div className="membership-card-left">
                  ...
                  <p className="membership-tagline">
                    Premium access to private events and
                ...
                <a
                  ...
                  href={`${import.meta.env.VITE_API_URL}/uploads/${app.cardPath}`}
                  target="_blank"
                  rel="noreferrer"
                >
                  Download PDF Card
        ...
        <div className="member-card-empty">
          ...
          <h3>
            No active cards <em>yet.</em>
          </h3>

          <p>
            Once your application is approved,
            your membership card will appear here.
          </p>
        </div>
      )}
      ...
      <div className="member-card-footer">
        ...
        <span className="tagline">
          Private · Social · Good Vibes Only
        </span>
